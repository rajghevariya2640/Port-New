...
import Img1 from '../../../assets/image/Home/png/RecentWork1.png'
import Img2 from '../../../assets/image/Home/png/RecentWork2.png'
import Img3 from '../../../assets/image/Home/png/RecentWork3.png'
import Img4 from '../../../assets/image/Home/png/RecentWork4.png'
import Img5 from '../../../assets/image/Home/png/RecentWork5.png'
import Img6 from '../../../assets/image/Home/png/RecentWork6.png'
      ...
      <PNContainer>
        <div className='flex justify-between items-center flex-wrap gap-y-4'>
          <div className='w-full lg:w-6/12'>
            <PNHeading subTitle='recent work' title='Expolore Our Recent Sucessfull Work' />
          </div>
           ...
           return (
             <SwiperSlide key={workIndex}>
               <div className="group/card h-[300px] sm:h-[350px] xl:h-[490px] lg:mb-5 lg:hover:h-[370px] xl:hover:h-[510px] lg:hover:mb-0 overflow-hidden duration-500 relative after:content-[''] after:absolute after:translate-x-[-50%] after:translate-y-[-50%] after:top-1/2 after:left-1/2 after:h-[92%] after:opacity-0 after:w-11/12 after:bg-primary-100 after:duration-500 after:hover:opacity-50">
                 <img src={work.img} className='group-hover/card:scale-[1.1] duration-500 h-full' alt={`Work ${workIndex + 1}`} />
                 <div className='flex absolute translate-x-[-50%] left-1/2 w-10/12 z-10 opacity-0 justify-center items-center gap-2.5 bottom-3 group-hover/card:bottom-14 group-hover/card:opacity-100 duration-500'>
                   <PNh5 className='text-cstmGrey-100 text-[16px] sm:!text-lg'>
                     {work.hoverText}
                   </PNh5>
               ...
               <PNh5 className='text-cstmGrey-100 mt-4 lg:mt-0'>
                 {work.head}
               </PNh5>
               <PNGreyTxt className='lg:mt-4'>
                 {work.info}
               </PNGreyTxt>
             </SwiperSlide>
           )
