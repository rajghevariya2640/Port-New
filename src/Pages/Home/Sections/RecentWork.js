          ...
          {work.map((work, workIndex) => {
             return (
               <SwiperSlide key={workIndex}>
                 <div className="group/card h-[490px] mb-5 hover:h-[510px] hover:mb-0 overflow-hidden duration-500 relative after:content-[''] after:absolute after:translate-x-[-50%] after:translate-y-[-50%] after:top-1/2 after:left-1/2 after:h-[92%] after:opacity-0 after:w-11/12 after:bg-primary-100 after:duration-500 after:hover:opacity-50">
                   <img src={work.img} className='group-hover/card:scale-[1.1] duration-500 h-full' />
                   <div className='flex absolute translate-x-[-50%] left-1/2 w-10/12 z-10 opacity-0 justify-center gap-2.5 bottom-3 group-hover/card:bottom-14 group-hover/card:opacity-100 duration-500'>
